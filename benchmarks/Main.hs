...
import SYB35PEOnly.AnonNames
import SYB35PEOnly.DropCasts
import SYB35PEOnly.IncInt
import SYB35PEOnly.IncSalary
import SYB35PEOnly.NumTypes
import SYB35PEOnly.RenumberInt
import SYB35PEOnly.RmWeights
import SYB35PEOnly.SelectFloat
import SYB35PEOnly.SelectInt
...
main =
    defaultMain
        [ bgroup
            ...
            , bench "SYB3.5 (full opt)" $ nf rmWeights₇ (bigwtree 10)
            ]
        , bgroup
            "IncSalary"
            ...
            , bench "SYB3.5 (full opt)" $ nf (incSalary₇ 0.1) (mkCompany 100)
            ]
        , bgroup
            "IncInt"
            ...
            , bench "SYB3.5 (full opt)" $ nf incInt₇ (mkExpr 20)
            ]
        , bgroup
            "SelectInt"
            ...
            , bench "SYB3.5 (full opt)" $ nf selectInt₇ (bigwtree 10)
            ]
        , bgroup
            "SelectFloat"
            ...
            , bench "SYB3.5 (full opt)" $ nf selectFloat₇ (mkCompany 100)
            ]
        , bgroup
            "NumTypes"
            ...
            , bench "SYB3.5 (full opt)" $ nf numTypes₇ (mkExpr 20)
            ]
        , bgroup
            "RenumberInt"
            ...
            , bench "SYB3.5 (full opt)" $ nf (renumberInt₇ 0) (bigwtree 10)
            ]
        , bgroup
            "AnonNames"
            ...
            , bench "SYB3.5 (PE only)" $ nf anonNames₆ (mkCompany 100)
        ...
        , bgroup
            ...
            , bench "SYB3.5 (full opt)" $ nf dropCasts₇ (mkExpr 20)
            ]
        ]
