-- A simple abstraction to keep doing stuff to the left-most component
-- of an expression
...
-- Keeps performing left elaboration until we reach a fixed point.
...
-- Left elaboration on an expression. We keep traversing leftwards only.
